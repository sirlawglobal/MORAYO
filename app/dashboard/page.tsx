...
export default async function DashboardPage() {
  ...
  const stats = [
    ...
    { label: 'Gallery Images', value: imageCount, icon: 'image', color: 'bg-indigo-500', trend: 'Storage at 42%' },
    { label: 'Love Stories', value: storyCount, icon: 'heart', color: 'bg-pink-500', trend: 'Timeline complete' },
    { label: 'Messages', value: recentRSVPs.filter((r: { message: string | null }) => r.message).length, icon: 'message', color: 'bg-amber-500', trend: 'New wishes' },
  ]
