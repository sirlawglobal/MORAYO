  ...
  return (
    <section id="support" className="py-32 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {/* Currency Switcher - Luxury Style */}
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-stretch">
          {/* Card 1: Bank Details - Silk White */}
          <motion.div 
            key={currency}
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-2xl font-serif text-brand-deep">{details[currency].bank}</p>
                </div>
                ...
                <div className="group/acc relative bg-white/50 p-6 rounded-3xl border border-white transition-all hover:bg-white">
                  ...
                  <div className="flex items-center justify-between">
                    <p className="text-4xl font-serif tracking-tighter text-brand-deep">{details[currency].accountNum}</p>
                    <button 
                ...
                <div>
                  ...
                  <p className="text-xl font-medium text-brand-deep/80">{details[currency].accountName}</p>
                </div>
              </div>
            </div>
          </motion.div>

          {/* Card 2: Digital Payment - Deep Purple Luxury */}
          <motion.div 
            initial={{ opacity: 0, x: 30 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8 }}
          ...
          >
             {/* Silk texture overlay inside dark card */}
